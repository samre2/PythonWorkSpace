...
print(-3 ** 2)  # Expected result: -9, because ** binds tighter than unary minus, so it's evaluated as -(3 ** 2)
...
print(a)  # Expected output: 30
a /= 3  # Equivalent to a = a / 3
print(a)  # Expected output: 10.0
a -= 4  # Equivalent to a = a - 4
print(a)  # Expected output: 6.0
a **= 2  # Equivalent to a = a ** 2
print(a)  # Expected output: 36.0
a //= 5  # Equivalent to a = a // 5
